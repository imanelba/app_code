...
if (isset($_GET['type'])) {
 ...
 if (isset($_POST['submit_update_patient'])) {
    ...
    $stmt = $conn->prepare($updateQuery);
    $stmt->bind_param("ssssssssssssi", $first_name, $last_name, $year_of_birth, $gender, $cin, $address, $email, $phone_number, $health_insurance, $emergency_contact, $emergency_number, $id);
